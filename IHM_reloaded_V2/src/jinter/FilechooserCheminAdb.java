...
public class FilechooserCheminAdb  extends JFrame  {
...
private JPanel contentPane;
	 ...
	 * @throws IOException 
	 */
	public FilechooserCheminAdb() throws IOException {
		...
		if(retour==JFileChooser.APPROVE_OPTION){
		   // chemin absolu du fichier choisi
			...
			Config.getTextField_5().setText(cheminChoisi);
			Ihm.setCheminAdb(cheminChoisi);
			ParserConfig.modifierCheminAdb(cheminChoisi);
		}
